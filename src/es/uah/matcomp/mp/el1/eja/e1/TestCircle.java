 ...
 */
public class TestCircle { // Save as "es.uah.matcomp.mp.l1.eja.e1.es.uah.matcomp.mp.el1.eja.e1.TestCircle.java"
...
//The circle has radius of 2.0 and area of 12.566370614359172
        ...
        System.out.println("The circle has radius of "
                + c3.getRadius() + " and area of " + c3.getArea() + " and color " + c3.getColor());
